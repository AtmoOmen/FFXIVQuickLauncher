...
internal class SettingsControlViewModel : INotifyPropertyChanged
{
    ...
    private void SetupLoc()
    {
        ...
        GamePathSafeguardRegionLoc = Loc.Localize
        (
        ...
        AutoLaunchHintLoc = Loc.Localize
        (
            "AutoLaunchHint",
        ...
        InGameAddonDescriptionLoc = Loc.Localize
        (
        ...
        InGameAddonCommandHintLoc = Loc.Localize
        (
        ...
        InGameAddonChatDelayDescriptionLoc = Loc.Localize
        (
        ...
        InGameAddonInjectionDelayDescriptionLoc = Loc.Localize
        (
        ...
        InGameAddonLoadMethodLoc = Loc.Localize
        (
            "InGameAddonLoadMethodLoc",
            "Choose how to load Dalamud."
        );
        InGameAddonLoadMethodEntryPointLoc = Loc.Localize
        (
        ...
        InGameAddonLoadMethodDllInjectDescriptionLoc = Loc.Localize
        (
        ...
        ChoosePatchAcquisitionMethodLoc = Loc.Localize("PatchAcquisitionMethod", "Choose the method used to acquire patches. We recommend \"ARIA(HTTP)\".");

        SettingsAboutLoc = Loc.Localize("SettingsAbout", "About");
        CreditsLoc = Loc.Localize
        (
            "Credits",

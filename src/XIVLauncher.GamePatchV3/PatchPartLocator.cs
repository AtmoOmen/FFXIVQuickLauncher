...
[Serializable]
public struct PatchPartLocator : IComparable<PatchPartLocator>
{
    ...
    public void WriteTo(BinaryWriter writer)
    {
        ...
        writer.Write(SourceOffsetUint);
        writer.Write(TargetSizeAndFlags);
        writer.Write(Crc32OrPlaceholderEntryDataUnits);
        writer.Write(SplitDecodedSourceFromUshort);
        writer.Write(TargetIndexByte);
        writer.Write(SourceIndexByte);
    }

    public void ReadFrom(BinaryReader reader)
    {
        TargetOffset                     = reader.ReadInt64();
        SourceOffsetUint                 = reader.ReadUInt32();
        TargetSizeAndFlags               = reader.ReadUInt32();
        Crc32OrPlaceholderEntryDataUnits = reader.ReadUInt32();
        SplitDecodedSourceFromUshort     = reader.ReadUInt16();
        TargetIndexByte                  = reader.ReadByte();
        SourceIndexByte                  = reader.ReadByte();
    }

    public int CompareTo(PatchPartLocator other)
    {
    ...
    private int FilterBufferSize(byte[] buffer, int bufferOffset, int bufferSize, int relativeOffset)
    {
        ...
        if (bufferSize > TargetSize - relativeOffset)
    ...
    public static void CalculateCrc32(ref PatchPartLocator part, Stream source)
    {

...
public class DCTravelMigrationOrder
{
    ...
    [JsonPropertyName("roleId")]     public string ContentID  { get; set; } = null!;
    [JsonPropertyName("groupId")]    public int    GroupID    { get; set; }
    [JsonPropertyName("groupCode")]  public string GroupCode  { get; set; } = null!;
    [JsonPropertyName("groupName")]  public string GroupName  { get; set; } = null!;
    [JsonPropertyName("createTime")] public string CreateTime { get; set; } = null!;
}

...
public static class MachineCode
{
    ...
    private static string GetDiskSerialNumber()
    {
        ...
        try
        {
            var getPartitionsOnDisk = new ManagementObjectSearcher("select * from Win32_DiskDrive");
    ...
    internal static class WINGetAdaptersInfo
    {
    ...
    internal sealed class CpuIdAssemblyCode : IDisposable
    {
